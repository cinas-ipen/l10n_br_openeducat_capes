...
{
    'name': 'Localização Brasileira OpenEduCat CAPES - Produtos Técnico-Tecnológicos (PTT)',
    'version': '19.0.1.0.0',
    'category': 'Education',
    'summary': 'Taxonomia GTPT / Medicina II, gestão de PTTs, coautoria, Qualis Tecnológico e visões analíticas.',
