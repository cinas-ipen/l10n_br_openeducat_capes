...
{
    'name': 'Localização Brasileira OpenEduCat CAPES - Admissão e Seleção',
    'version': '19.0.1.0.0',
    'category': 'Education',
    'summary': 'Editais de concorrência pública, fases de seleção, soberania do coordenador, plano de trabalho e perfil de egressos.',
