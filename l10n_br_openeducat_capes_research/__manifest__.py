...
{
    'name': 'Localização Brasileira OpenEduCat CAPES - Pesquisa e Fomento',
    'version': '19.0.1.0.0',
    'category': 'Education',
    'summary': 'Gerenciamento de projetos científicos, fomento, cooperação internacional e taxonomia CRediT.',
